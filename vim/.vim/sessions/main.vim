...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/undotree,~/.vim/plugged/nerdtree,~/.vim/plugged/indentLine,~/.vim/plugged/python-syntax,~/.vim/plugged/animate.vim,~/.vim/plugged/lens.vim,~/.vim/plugged/vim-diminactive,~/.vim/plugged/awesome-vim-colorschemes,~/.vim/plugged/goyo.vim,~/.vim/plugged/vim-pencil,~/.vim/plugged/colorizer,~/.vim/plugged/vim-colors-xcode,~/.vim/plugged/tokyonight-vim,~/.vim/plugged/vim-lsp,~/.vim/plugged/vim-lsp-settings,~/.vim/plugged/asyncomplete.vim,~/.vim/plugged/asyncomplete-lsp.vim,~/.vim/plugged/catppuccin,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set softtabstop=4
...
$argadd .config/zsh/env.zsh
$argadd .config/zsh/functions.zsh
$argadd .config/zsh/history.zsh
$argadd .config/zsh/key-bindings.zsh
$argadd .config/zsh/plugins.zsh
$argadd .config/zsh/prompt.zsh
$argadd .config/zsh/theme.zsh
$argadd .config/zsh/utility.zsh
$argadd .Xresources
$argadd .vim
...
normal! 023|
tabnext
edit .config/zsh/key-bindings.zsh
argglobal
5argu
balt .config/zsh/alias.zsh
setlocal keymap=
...
argglobal
if bufexists(fnamemodify(".config/sxhkd/sxhkdrc", ":p")) | buffer .config/sxhkd/sxhkdrc | else | edit .config/sxhkd/sxhkdrc | endif
