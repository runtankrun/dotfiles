...
$argadd .Xresources
$argadd .zshrc
$argadd .oh-my-zsh/custom/alias.zsh
$argadd .config/sxhkd/sxhkdrc
$argadd .config/bspwm/bspwmrc
$argadd .config/picom/picom.conf
