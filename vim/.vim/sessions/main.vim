...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/undotree,~/.vim/plugged/nerdtree,~/.vim/plugged/indentLine,~/.vim/plugged/python-syntax,~/.vim/plugged/animate.vim,~/.vim/plugged/lens.vim,~/.vim/plugged/awesome-vim-colorschemes,~/.vim/plugged/goyo.vim,~/.vim/plugged/vim-pencil,~/.vim/plugged/colorizer,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set shiftwidth=4
set smartcase
set smartindent
set softtabstop=4
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 80 + 108) / 217)
exe 'vert 2resize ' . ((&columns * 68 + 108) / 217)
exe 'vert 3resize ' . ((&columns * 67 + 108) / 217)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((36 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 44 - ((41 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
let s:c = 18 - ((2 * winwidth(0) + 33) / 67)
if s:c > 0
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 195 + 108) / 217)
exe 'vert 2resize ' . ((&columns * 21 + 108) / 217)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((32 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
let s:c = 9 - ((7 * winwidth(0) + 10) / 21)
if s:c > 0
  exe 'normal! ' . s:c . '|zs' . 9 . '|'
else
  normal! 09|
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 122 - ((73 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
122
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 36 + 108) / 217)
exe 'vert 2resize ' . ((&columns * 36 + 108) / 217)
exe 'vert 3resize ' . ((&columns * 35 + 108) / 217)
exe '4resize ' . ((&lines * 76 + 40) / 81)
exe 'vert 4resize ' . ((&columns * 107 + 108) / 217)
exe '5resize ' . ((&lines * 1 + 40) / 81)
exe 'vert 5resize ' . ((&columns * 107 + 108) / 217)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 44 - ((43 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
wincmd w
argglobal
if bufexists(".config/ranger/kitty/rc.conf") | buffer .config/ranger/kitty/rc.conf | else | edit .config/ranger/kitty/rc.conf | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
normal! zt
25
let s:c = 18 - ((14 * winwidth(0) + 18) / 36)
if s:c > 0
  exe 'normal! ' . s:c . '|zs' . 18 . '|'
else
  normal! 018|
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 152 - ((37 * winheight(0) + 38) / 76)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
...
wincmd w
argglobal
if bufexists(".config/ranger/kitty/rifle.conf") | buffer .config/ranger/kitty/rifle.conf | else | edit .config/ranger/kitty/rifle.conf | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((12 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
badd +1 .config/ranger/kitty/rc.conf
badd +34 .config/ranger/rc.conf
badd +147 .config/ranger/rifle.conf
badd +0 .config/ranger/kitty/rifle.conf
